...
public class PlayerController implements InputProcessor {
    ...
    public boolean keyDown(int keycode) {
        if (keycode == Input.Keys.LEFT || keycode == Input.Keys.A || keycode == Input.Keys.NUMPAD_4) {
            this.leftPressed();
        }
        if (keycode == Input.Keys.RIGHT || keycode == Input.Keys.D || keycode == Input.Keys.NUMPAD_6) {
            this.rightPressed();
        }
        if (keycode == Input.Keys.UP || keycode == Input.Keys.W || keycode == Input.Keys.NUMPAD_8) {
            this.upPressed();
        }
        if (keycode == Input.Keys.DOWN || keycode == Input.Keys.S || keycode == Input.Keys.NUMPAD_2) {
            this.downPressed();
        }
